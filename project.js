...
const prize=new Audio('gamepoint.wav');
const nulll=new Audio('lose.wav');
const endd=new Audio('totallose.wav');
const winn=new Audio('totalwin.wav');
const themee=new Audio('theme.mp3');
...
function size(n,m){  
    ...
    console.log(arr);                  /*uncomment this line to check the cheat codes on console*/
...
function guessed(){
    ...
    console.log(choosed+" moves-"+moves+" count"+count);    /*uncomment this line to check the cheat codes on console*/
    if(arr[num]==null){
        nulll.play();
        arr[num]=-1;
        document.getElementById(choosed).style.color="transparent";
        document.getElementById(choosed).style.backgroundImage= "url('none.gif')";
    }
    else if(arr[num]=='🏆'){
        prize.play();
        document.getElementById(choosed).style.color="transparent";
        document.getElementById(choosed).style.backgroundImage= "url('diamond.gif')";
        count++;
        arr[num]=-1;
        console.log(count);
        if(count==n){
        ...
        endd.play();
        document.getElementById(choosed).style.color="transparent";
        document.getElementById(choosed).style.backgroundImage= "url('bomb.gif')";
